...
Four methods of this package are presented here, with several examples of each. These methods are called 
{\tt cisPath}, {\tt addProteinNames}, {\tt networkView} and {\tt easyEditor}.
